...
export class AuthenticationCore {
    ...
    getAuthorizationURLParams(config, userID) {
        var _a, _b, _c;
    ...
    getAuthorizationURL(config, userID) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const authorizeRequestParams = yield this.getAuthorizationURLParams(config, userID);
    ...
    requestAccessToken(authorizationCode, sessionState, state, userID, tokenRequestConfig) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (tokenRequestConfig === null || tokenRequestConfig === void 0 ? void 0 : tokenRequestConfig.params) {
